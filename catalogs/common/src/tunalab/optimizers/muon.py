...
class MuonTestAdapter:
    """
    Adapter for the Muon optimizer. 
    
    NOTE: This adapter provides a simplified interface that automatically separates
    parameters by their dimensionality (1D vs. 2D+). This is suitable for simple
    models or for initial testing. For complex models like transformers, it is
    HIGHLY recommended to manually create parameter groups to ensure that Muon
    is not applied to input embeddings or output projection layers.
    
    This adapter is primarily for informational and testing purposes.
    """
